...
export default function Ledger() {
  ...
  const totalChunks = docs.reduce((s: number, d: Record<string, unknown>) => s + Number(d.chunk_count ?? 0), 0)
          ...
          {docsLoading ? (
            ...
            <div className="overflow-x-auto">
              <table className="w-full text-sm">
                ...
                <tbody>
                  {(docs as Record<string, unknown>[]).map((doc, i) => {
                    ...
                    return (
                      <tr key={i} className="border-b last:border-0 hover:bg-muted/40">
                        ...
                        <td className="px-4 py-2">
                          <QualityBadge score={Number(doc.quality_score ?? 0)} />
                        </td>
      ...
      <Card>
        ...
        <CardContent className="p-0">
          <table className="w-full text-sm">
            ...
            <tbody>
              {(snapshots as Record<string, unknown>[]).map((s, i) => (
