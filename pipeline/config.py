...
class Settings:
    ...
    mongodb_coll_knowledge_bases:    str = os.getenv("MONGODB_COLL_KNOWLEDGE_BASES",    "knowledge_bases")
    mongodb_coll_vector_stores:      str = os.getenv("MONGODB_COLL_VECTOR_STORES",      "vector_stores")
